...
const deleteUsersAPI = createAsyncThunk('/delete-users', async (listID, thunkAPI) => {
  try {
    const response = await axiosClient.post('/admin/delete-users', JSON.stringify({ data: listID }));
